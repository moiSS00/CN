# -*- coding: utf-8 -*-
"""
Ejercicio 2: Resolución de un sistema lineal con el método de Gauss-Seidel.

Función gauss_seidel: Calcula utilizando el método de Gauss-Seidel la solución 
...
Ejemplos: 
        ...
        b = np.array([1.,1,1,1])
        x, k = gauss_seidel(A,b,tol)
        print('x =',x)        
        print('Iteraciones =', k)
        Salida:
            x = [ 0.09375  0.25    -0.09375 -0.1875 ]
            Iteraciones = 8
...
def gauss_seidel(A,b,tol,maxiter=1000):
    ...
    while test_parada == False and k < maxiter:       
        ...
        for i in range(0,len(x)):  
            ...
            x[i] = (1/A[i,i])*(b[i] - sumatorio) # fórmula de Gauss-Seidel
            sumatorio = 0
